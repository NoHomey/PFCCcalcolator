function CurrentStateOfExpander() {
    this.CurrentState = function (State) {
        document.getElementById("Select1").size = document.getElementById("Select2").size = document.getElementById("Select3").size = document.getElementById("Select5").size = 1;
        if (State === "UnList Options") {
            ...
            document.getElementById("Select5").size = document.getElementById("Select5").length;
        } else {
